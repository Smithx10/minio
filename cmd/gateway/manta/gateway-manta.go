...
func (t *tritonObjects) StorageInfo(ctx context.Context) (si minio.StorageInfo, _ []error) {
...
func (t *tritonObjects) MakeBucketWithLocation(ctx context.Context, bucket string, opts minio.BucketOptions) error {
...
func (t *tritonObjects) DeleteBucket(ctx context.Context, bucket string, forceDelete bool) error {
...
func (t *tritonObjects) PutObject(ctx context.Context, bucket, object string, r *minio.PutObjReader, opts minio.ObjectOptions) (objInfo minio.ObjectInfo, err error) {
	data := r.Reader
	...
	if err = t.client.Objects().Put(ctx, &storage.PutObjectInput{
		...
		ContentMD5:   opts.UserDefined["content-md5"],
...
func (t *tritonObjects) DeleteObject(ctx context.Context, bucket, object string, opts minio.ObjectOptions) (minio.ObjectInfo, error) {
...
func (t *tritonObjects) DeleteObjects(ctx context.Context, bucket string, objects []minio.ObjectToDelete, opts minio.ObjectOptions) ([]minio.DeletedObject, []error) {
	errs := make([]error, len(objects))
	dobjects := make([]minio.DeletedObject, len(objects))

	for idx, object := range objects {
		errs[idx] = t.client.Objects().Delete(ctx, &storage.DeleteObjectInput{
			ObjectPath: path.Join(mantaRoot, bucket, object.ObjectName),
		})
		if errs[idx] == nil {
